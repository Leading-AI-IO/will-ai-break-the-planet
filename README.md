...
**数十兆円のインフラ投資と、気候の「不可逆ライン」をめぐる時間の賭け / The AI Infrastructure Boom and the Race Against the Climate's Point of No Return**
...
その一方で、ほとんど誰も賭け金を数えていない問いがある。**世界中のAI企業と資本と政府が数十兆円規模のAIインフラ投資に注力する過程で、いったいどれだけのCO2が排出され、それは地球に、そして人類に、最終的に何をもたらすのか。**

本書は終末論ではない。むしろ、この問題で最も権威ある公式見解——IEAの「データセンターのCO2は世界排出の約1%にすぎず、2030年頃にピークアウトする」という楽観的予測——を正面から受け止めることから始める。だが本書が問うのは「量」ではない。**「方向」と「時間」だ。**

そのピークアウトは、SMR・新規原子力・送電網・再エネが「予定通りに間に合う」という前提の上に立つ。予測ではなく、賭けである。そして、その賭けが「間に合う」とされる時間軸は、地球が不可逆な臨界点（ティッピングポイント）を越えるリスクが急騰する時間軸と、重なっている。

判定ではない。本書は、AIインフラ投資・気候の不可逆性・安全保障の帰結・人間の認知バイアスという、これまで別々に語られてきた**四つの議論を一本の線でつなぎ、「時間軸の衝突」という一つの構造として記述する**ことを目的とするOSS書籍である。
...
| ファイル | 言語 | 内容 |
| --- | --- | --- |
| [will-ai-break-the-planet_JP.md](./docs/jp/will-ai-break-the-planet_JP.md) | 🇯🇵 日本語 | 本文（日本語版） |
| [will-ai-break-the-planet_EN.md](./docs/en/will-ai-break-the-planet_EN.md) | 🇺🇸 English | 本文（英語版） |
...
- **序章:** 飛ばされた計算
- **第1章:** 異次元の投資 — 賭け金の規模
- **第2章:** 公式の楽観 — IEAは「1%・ピークアウト」と言っている
- **第3章:** 賭けの正体 — ピークアウトが依存する三つの前提
- **第4章:** 時間軸の衝突 — 解決策より先にリスクの窓が開く
- **第5章:** 不可逆の先で起きること — 居住地・水・作物の物理的帰結
- **第6章:** 人が、人を襲う — 資源争奪から紛争、そして人命へ
- **第7章:** なぜ、誰も賭け金を数えないのか — 認知バイアスの構造
- **終章:** 賭けを、可視化する — 不可逆の時間軸を意思決定の計算に入れよ
...
Issues and Pull Requests are welcome. 本書の構造分析に対するフィードバック、AIインフラ投資・エネルギー・気候の最新動向の追加情報、誤字脱字の修正など、皆様からのContributeを歓迎します。
